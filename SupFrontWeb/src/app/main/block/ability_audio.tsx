...
import {CallCfgAudioAction} from "@/app/api/route_api";
...
import {Row, GetNewRows, CfgProps} from "@/app/main/block/audio_cfg";
    ...
    return (
        rows?.map((row) => (
            <Grid container direction="row">
                ...
                <SnackBarInfo autoHideDuration={5000} infoContent={"成功"} shouldShow={showInfo} setShouldShow={setShowInfo}/>
            </Grid>
        ))
    )
}
        ...
        <div>
            <Grid item xs={12} flexDirection='column' display='flex'>
                <Container>
                    ...
                    <SnackBarInfo autoHideDuration={5000} infoContent={"转表成功"} shouldShow={showInfo} setShouldShow={setShowInfo}/>
                </Container>
                <p>
                    3_物品配置_RP
                </p>
